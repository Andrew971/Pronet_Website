...
export  class NavItemFr extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
        ...
        <ul>
          ...
          <li>
              ...
              <div className="dropdown-content">
                <span onClick={() => { history.push("/classic") }}>Classique</span>
                <span onClick={() => { history.push("/specific") }}>Spécifique</span>
...
export default withRouter(connect(mapStateToProps)(NavItemFr));
